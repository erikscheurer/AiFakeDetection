...
#%%
def plot_smoothed_runs(logdir, runs, tags, title=None, window=10, save_path=None, colors = 'bgrcmyk', labels=None, maxiter=100000):
    cmap = get_cmap('tab10')
...
tags = ['transfer_fake_acc']#,'accuracy_fake','accuracy_real','transfer_all_acc','transfer_fake_acc','transfer_real_acc']
generator_dict = {
    'ImageNet': -1,
...
plot_smoothed_runs(logdir=logdir, runs=runs, tags=tags, title=title, window=2000, save_path=save_path,labels=labels)
